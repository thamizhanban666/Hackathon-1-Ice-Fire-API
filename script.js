...
div8.classList.add("col-1","fw-bold","border","border-dark","py-4","fs-5")
div8.innerText = "Img";
parentDiv.appendChild(div8);
...
div7.classList.add("col-1","fw-bold","border","border-dark","py-4","px-0","fs-6")
